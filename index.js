            ...
            return {
                ...
                moderation: {
                    ...
                    inviteFiltering: {
                        ...
                        whitelistedGuilds: [],
                        warn: false,
                        warnMessage: `Your content has been flagged as an advertisement. You now have %WARNCOUNT% warns.`,
                        actions: []
                    },
                    warns: {
                        actions: {
                            5: {
                                action: 'mute',
                                message: `Guess what, you just reached %WARNCOUNT% warns and therefore you've been muted.`,
